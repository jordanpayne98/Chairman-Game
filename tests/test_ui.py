...
class InterfaceTests(unittest.TestCase):
    def test_connected_management_flow(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            click('Finances');click('Budget +£2k');click('Recruitment');app.profile='p144';click('Review signing');click('Confirm')
            ...
            click('Back the manager');click('Confirm');click('Skip to full time');click('Finish review');click('Save')
