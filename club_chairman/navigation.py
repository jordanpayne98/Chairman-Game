...
SCREENS=('Overview','Inbox','Squad','Staff','Recruitment','Contracts','Transfers','Commercial',
         'Academy','Facilities','Finances','League','Cup','Fixtures','Matchday','Career','Reputation','Settings','Help','Activity')
HELP={
    'reputation prestige standing milestones career evidence':'Reputation',
    'cup knockout draw trophy competition penalties':'Cup',
